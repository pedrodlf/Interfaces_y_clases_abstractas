        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <!-- Header -->
                    <header id="header">
                        <a href="principal.jsp" class="logo"><strong>Editorial</strong> by HTML5 UP Usuario <%=usuario%></a>
                        <ul class="icons">
                        ...
                        <html:form action="Billing.do" method="POST">
                            <div class="row uniform">
                                <div class="6u 12u$(small)">
                                    <h5 id="nftxt">Fecha de Factura</h5>
                                    <input type="text" name="demo-fecha" id="demo-name" value="<%=fecha%>" placeholder=<%=fecha%> />
                                </div>

                                <div class="6u 12u$(small)">
                                    <h5 id="nftxt">Nº de Factura</h5>
                                    <input type="text" name="demo-factura" id="demo-factura" value=<%=numerofactura%> placeholder=<%=numerofactura%> />
                                </div>

                                <div class="6u 12u$(small)">
                                    <input type="text" name="factura-vencimiento" id="factura-vencimiento" value="" placeholder=<%=fechaMod%> />
                                </div>
